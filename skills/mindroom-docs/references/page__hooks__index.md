...
Historical joins and membership state snapshots silently record existing members before Nio acknowledgement, preventing later profile updates from triggering onboarding.
